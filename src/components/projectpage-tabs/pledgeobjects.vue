        ...
        data () {
            return {
                ...
                planned: [
                    ...
                    { text: 'Тип', value: 'status' },
                    { text: 'Статус', value: 'main_contact', sortable: true },
                    { text: 'Балансодержатель', value: 'main_phone', sortable: true },
                    { text: 'Балансовая стоимость', value: 'email', sortable: false },
                    { text: 'Дата принятия в работу', value: 'city', sortable: false }
                ]
