        ...
        data () {
            return {
                ...
                planned: [
                    ...
                    { text: 'Наименование', value: 'role' },
                    { text: 'Дата заключения', value: 'status' },
                    { text: 'Дата закрытия', value: 'main_contact', sortable: true },
                    { text: 'Залогодатель', value: 'main_phone', sortable: true },
                    { text: 'Статус', value: 'email', sortable: false },
                    { text: 'Залоговая стоимость', value: 'city', sortable: false },
                    { text: 'Реальная стоимость', value: 'city', sortable: false }
                ]
